  ...
  return (
    <aside className="flex flex-col w-full md:w-60 lg:w-full p-4 gap-4">
      ...
      <div className="pb-4 border-b border-[var(--color_text_title)]/30">
        ...
        <div className="flex w-full items-center gap-2 px-3 py-2 border border-[var(--background_button)] rounded-md text-[var(--color_text_title)]">
          <input
            ref={inputRef}
            type="text"
          ...
          <div className="mt-2 flex flex-col gap-2">
            ...
            <button
              ...
              className={`text-left px-2 py-1 rounded ${
                !classificationFilter
                  ? "bg-[var(--background_button)] text-[var(--color_text_button)]"
                  : "hover:bg-[var(--background_sidebar)] hover:text-[var(--color_text_button)]"
              }`}
            >
              Semua Klasifikasi
            </button>
